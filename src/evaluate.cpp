...
namespace {
  ...
  const Score MobilityBonus[][32] = {
    {}, {},
    { S( -30,-59), S(-37,-42), S(-17,-17), S( 8,-16), S( 17, 15), S(30, 31), // Knights
      S(  38, 48), S( 38, 47), S( 63, 47) },
    { S( -71,-43), S(-25,-29), S( 17, -7), S(18, 29), S( 48, 27), S(53, 52), // Bishops
      S(  60, 45), S( 69, 46), S( 58, 86), S(67, 50), S( 73, 77), S(96, 54),
      S( 117, 29), S( 45, 47) },
    { S(-106,-85), S(-15,-21), S(  8,-14), S( 6, 11), S( 16, 55), S( 8, 68), // Rooks
      S(  23, 84), S( 25, 80), S( 49, 87), S(44,103), S( 41,116), S(38,121),
      S(  52,125), S( 49,140), S( 75,122) },
    { S( -33,-38), S(-58,-43), S(-31, 26), S(-1,-12), S( -2,  9), S( 4, 33), // Queens
      S(  23, 85), S( 43,  9), S( 58, 62), S(53, 61), S( 57, 54), S(48, 66),
      S(  53, 59), S( 80, 52), S(  2, 82), S(84, 98), S( 75, 59), S(69, 77), 
      S(  37, 72), S( 73, 61), S(122, 53), S(77, 60), S(116,130), S(84,101), 
      S(  69, 69), S(116, 75), S(108, 79), S(85, 97) }
  };
